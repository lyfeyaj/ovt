...
chainable('desc', { method: utils.noop, chainableBehaviour: addDescription });
chainable('description', { method: utils.noop, chainableBehaviour: addDescription });
...
chainable('note', { method: utils.noop, chainableBehaviour: addNotes });
chainable('notes', { method: utils.noop, chainableBehaviour: addNotes });
...
chainable('tag', { method: utils.noop, chainableBehaviour: addTags });
chainable('tags', { method: utils.noop, chainableBehaviour: addTags });
...
chainable('virtual', { method: utils.noop, chainableBehaviour: addVirtual });
...
chainable('default', { method: utils.noop, chainableBehaviour: addDefault });
