...
module.exports = {
  any: {
    ...
    validKeys: 'must be one of "{{args}}"',
    onlyKeys: 'must be one of "{{args}}"',
    whitelistKeys: 'must be one of "{{args}}"',
    oneOfKeys: 'must be one of "{{args}}"',
    invalidKeys: 'can\'t be one of "{{args}}"',
    notKeys: 'can\'t be one of "{{args}}"',
    disallowKeys: 'can\'t be one of "{{args}}"',
    blacklistKeys: 'can\'t be one of "{{args}}"',
  },
  ...
  array: {
    ...
    requireds: '{{preferedLength}} valid elements are required, now is {{currentLength}}',
    isLength: 'length must be {{0}}',
    length: 'length must be {{0}}',
    maxLength: 'length must be less than or equal to {{0}}',
    max: 'length must be less than {{0}}',
    minLength: 'length must be longer than or equal to {{0}}',
